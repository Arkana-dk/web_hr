...
Route::middleware(['auth:sanctum'])->group(function () {
     ...
     * NOTE: Spatie guard override dipaksa ke 'api' ⇒ 'permission:xxx,api'
     * ======================================================================
     */
    Route::prefix('admin')->name('admin.')->group(function () {
        ...
        // Attendance approval (approve/reject)
        Route::middleware('permission:hr.attendance.approve,api')->group(function () {
            ...
            Route::apiResource('overtime-requests', ApiAdminOvertimeRequestController::class)->only(['index','store','show','update','destroy']);
    ...
    /* ======================================================================
     * EMPLOYEE API (prefix: /api/employee)
     * ======================================================================
     */
    Route::prefix('employee')->name('employee.')->group(function () {
        ...
        // Payslip (self) — guard permission: api
