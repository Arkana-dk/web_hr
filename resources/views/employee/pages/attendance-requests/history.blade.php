  ...
  <div class="card border-0 shadow rounded-4">
    <div class="card-header bg-white border-0 d-flex justify-content-between align-items-center">
      <h4 class="mb-0 text-primary">
        <i class="fas fa-user-clock me-2"></i>Riwayat Pengajuan Presensi
      </h4>
    </div>
          ...
          <tbody>
            @forelse($requests as $req)
              <tr>
                ...
                <td>
                  <span class="badge bg-info text-dark">{{ ucfirst($req->type) }}</span>
                </td>
                <td>
            ...
            @empty
              <tr>
                <td colspan="5" class="text-muted text-center py-3">Belum ada pengajuan.</td>
              </tr>
            @endforelse
          </tbody>
        </table>
